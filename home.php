...
<body>
                    ...
                    ?>
                        <tbody>
                            ...
                            <td>
                                ...
                                <button type="button" id="<?php echo $redRez["rezID"] ?>" class="btn btn-success fw-bold" onClick="reply_rezID(this.id)" 
                                    data-toggle="modal" data-target="#izmeniRez"  >IZMENI</button>
    ...
    <div class="modal fade" id="izmeniRez" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ZATVORI</button>
            ...
            <div class="modal-body">
                ...
                <div class="row justify-content-center">
                    <div class="col">
                        ...
                        <div class="form-group">
                            <input type="text" id="stoNaziv1" value="X" class="form-control form-control-lg mb-3" name="stoNaziv1" required>
                        </div>
                        <div class="form-group">
